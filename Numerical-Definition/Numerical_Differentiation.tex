...
The expansion of equation $\ref{E1}$ can be done using taylor series expansion
...
\begin{equation*}
\begin{split}
f(x_{n}+\alpha_{i}h_{n}, y_{n}+\sum_{j=1}^{i-1}\beta_{ij}k_{j}) =& f(x_{n},y_{n}) + \bigg[\alpha_{i}h_{n}\frac{\partial}{\partial y} + \sum (\beta_{ij})h_{n}f_{n}\frac{\partial}{\partial y}\bigg]f(x_{n},y_{n})\\
																& + \frac{1}{2!}\bigg[\alpha_{i}h_{n}\frac{\partial}{\partial y} + \sum (\beta_{ij}) h_{n}f_{n}\frac{\partial}{\partial y}\bigg]^{2}f(x_{n},y_{n})\\
																& + \frac{1}{3!}\bigg[\alpha_{i}h_{n}\frac{\partial}{\partial y} + \sum (\beta_{ij}) h_{n}f_{n}\frac{\partial}{\partial y}\bigg]^{3}f(x_{n},y_{n})\\ 
																& + ........................\\
																& + \frac{1}{n!}\bigg[\alpha_{i}h_{n}\frac{\partial}{\partial y} + \sum (\beta_{ij}) h_{n}f_{n}\frac{\partial}{\partial y}\bigg]^{n}f(x_{n},y_{n})												
\end{split}
\end{equation*}
}
...
\begin{equation}
\begin{split}
f(x_{n}+\alpha_{i}h_{n}, y_{n}+\sum_{j=1}^{i-1}\beta_{ij}k_{j}) =& \sum_{t=0}^{\infty}\frac{\bigg(\alpha_{i}h_{n}\frac{\partial}{\partial x} + \sum (\beta_{ij})h_{n}f_{n}\frac{\partial}{\partial y}\bigg)^{t}}{t!}f(x_{n},y_{n})
\end{split}
\end{equation}
}
...
k_{3} = & h_{n}f(x_{n}+\alpha_{3}h_{n},y_{n}+\beta_{31}k_{1}+\beta_{32}k_{2})\\
	  =	& h_{n}f\bigg[x_{n}+\alpha_{2}h_{n},y_{n}+h_{n}f_{n}(\beta_{31}+\beta_{32})+\beta_{32}(k_{2}-h_{n}f_{n})\bigg]\\
...
\begin{align*}
k_{i} &= h_{n}f(x_{n}+\alpha_{i}h_{n}, y_{n}+\sum_{j=1}^{i-1}\beta_{ij}k_{j}) &   &   &   &    &     &	&	 & 	&\\
	  &= h_{n}f\bigg[x_{n}+\alpha_{4}h_{n}, y_{n}+(\sum_{j=1}^{i-1}\beta_{ij})h_{n}f_{n} + \bigg(\sum_{j=2}^{i-1}\beta_{ij}(k_{j}-h_{n}f_{n})\bigg)\bigg] &    &     &     &	  &		&   &    &	  &\\
